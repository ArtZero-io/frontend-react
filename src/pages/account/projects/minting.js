...
import {
  ...
  import { convertStringToPrice, truncateStr, convertStringToDateTime } from "@utils";
                          ...
                          <TableContainer
                            ...
                            >
                              ...
                              >
                                ...
                                <Text py={2}>
                                    Minting Fee: {convertStringToPrice(currentPhase.publicMintingFee)} <AzeroIcon mb="5px" />
                                </Text>
                                <Text py={2}>
