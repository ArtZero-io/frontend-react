...
const MintingEventPage = () => {
  ...
  useEffect(
    ...
    [dispatch, activeAddress, onClickWhiteList]
  );
  ...
  return (
    <>
      {!currentAccount?.address ? (
        ...
        <>
          <Button size="sm" onClick={() => onClickWhiteList()}>
            get_whitelist
          </Button>
          <p>Your address: {activeAddress}</p>
          <p>
            You are {whitelist ? "in the whitelist" : "not in the whitelist"}
          </p>
          <p>
            {whitelist
              ? "You can claim " + whitelist.whitelistAmount + " NFTs"
              : ""}
          </p>
          <p>
            {whitelist
              ? "You already claimed " + whitelist.claimedAmount + " NFTs"
              : ""}
          </p>
        </>
      )}
