        ...
        <>
          ...
          <Box align="center" position="relative" bg="green.500" padding="2">
            <Text>
              {" "}
              <strong>
                Nếu ai được thưởng token thì sẽ nằm trong Whitelist và sẽ mint
                (tạo ra) được NFT của ArtZero miễn phí. Còn lại sẽ phải Mint với
                1 mức phí nhất định tuỳ giai đoạn. GĐ 1: tối đa {amount1} NFTs
                giá {fee1}, GĐ 2: giá {fee2}
              </strong>
            </Text>
          </Box>
          <Box as="section" pt="20" pb="12" position="relative">
            <Flex color="white">
              <Box flex="1" bg="blue.500" margin="2" padding="2">
                ...
                <Text>
                  Your address: <strong>{truncateStr(activeAddress, 9)}</strong>
                </Text>
                <Text>
                  Your ArtZero's NFT Balance: <strong>{balance} NFTs</strong>
                </Text>
                <br />
                <Text>ArtZero's NFT information:</Text>
                <Text>
                  Total Supply: <strong>10,000</strong>
                </Text>
                <Text>
                  Total Minted: <strong>{totalMinted}</strong>
                </Text>
              </Box>
              <Box flex="1" bg="blue.500" margin="2" padding="2">
                <Text>
                  You are{" "}
                  {whitelist
                    ? "in the whitelist for minting ArtZero NFTs"
                    : "not in the whitelist for minting ArtZero NFTs"}
                </Text>
                <Text>
                  {whitelist
                    ? "You can claim " +
                      whitelist.whitelistAmount +
                      " ArtZero NFTs"
                    : ""}
                </Text>
                <Text>
              ...
              <Box flex="1" bg="blue.500" margin="2" padding="2">
                ...
                {mintMode === 1 ? (
                  <>
                    <Text>
                      Minting fee is <strong>{fee1} AZERO</strong>
                    </Text>
                    <Text>
                      Max Mint: <strong>{amount1} NFTs</strong>
                    </Text>
                  </>
                ) : null}
                {mintMode === 2 ? (
                  <>
                    <Text>
                      Minting fee is <strong>{fee2} AZERO</strong>
                    </Text>
                    <Text>
                      Max Mint: <strong>{amount1} NFTs</strong>
                    </Text>
                ...
                <br />
                <Button size="sm" color="black" onClick={() => onPaidMint()}>
                  Mint Now
                </Button>
              </Box>
            </Flex>
