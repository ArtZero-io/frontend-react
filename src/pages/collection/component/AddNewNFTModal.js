      ...
      >
        ...
        <FormControl>
          ...
          <Input
            ...
            type="text"
            onChange={({ target }) =>
              updateAttributes(target.value, "name", "base")
            }
          />
        </FormControl>
        <FormControl>
          ...
          <Input
            ...
            type="text"
            onChange={({ target }) =>
              updateAttributes(target.value, "description", "base")
            }
          />
        </FormControl>
        <FormControl>
          <FormLabel htmlFor="nft_image">NFT Image</FormLabel>
          <Input id="nft_image" type="file" onChange={handleNFTImage} />
        </FormControl>
        <Button onClick={() => addFormPropertyFields()}>
          Add New Property
        </Button>
        {formPropertyValues.map((element, index) => (
          <div className="form-inline" key={index}>
            ...
            <input
              ...
              name="name"
              value={element.name || ""}
              onChange={(e) => handleChangePropertyField(index, e)}
            />
            <label>Value</label>
            <input
              type="text"
            ...
            <button
              ...
              onClick={() => removeFormPropertyFields(index)}
            >
              Remove
            </button>
          </div>
        ...
        {formLevelValues.map((element, index) => (
          <div className="form-inline" key={index}>
            ...
            <button
              type="button"
              className="button remove"
              onClick={() => removeFormLevelFields(index)}
            >
              Remove
            </button>
          </div>
