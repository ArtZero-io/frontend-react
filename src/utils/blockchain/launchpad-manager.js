const launchpad_manager = {
  CONTRACT_ADDRESS: "5DLMuHsW49fJ2pthvCfgWcTj28S1FHV5giDUWaZxxUamus3F",
  CONTRACT_ABI: {
    source: {
      hash: "0x054d1a54de168afdaddda5f017a2342bfc7f28781703693ae8a5ec0a9a2dfa8d",
      language: "ink! 3.3.0",
      ...
      spec: {
        ...
        messages: [
          ...
          },
          {
            ...
            docs: [" Edit a project - Only project owner and admin"],
            label: "edit_project",
            mutates: true,
            payable: false,
            returnType: {
          ...
          },
          {
            ...
            docs: [" Update admin address - Only Owner"],
          ...
          },
          {
            ...
            docs: [" update project adding fee - Only Admin"],
          ...
          },
          {
            ...
            docs: [" Update project mint fee rate - Only Admin"],
          ...
          },
          {
            ...
            docs: [" Update standard nft hash - Only Owner"],
          ...
          },
          {
            ...
            docs: [" Update is active project - Only Admin"],
          ...
          },
          {
            ...
            docs: [" Get projects by owner address"],
          ...
          },
          {
            ...
            docs: [" Get project by NFT address"],
                  ...
                  fields: [
                    ...
                    },
                    {
                      layout: {
                        enum: {
                          dispatchKey:
                            "0x248cb4a8e1768578ab199af6c3822baceafe928fad843580aa9862286e062059",
                          variants: {
                            0: {
                              fields: [
                                {
